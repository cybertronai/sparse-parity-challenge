...
|------|--------|--------|-----|------|----------|-------|
| 1 | GF(2) Ultra-Minimal (n+1 samples, retry) | [@SethTS](https://github.com/SethTS) | 286,011 | 0.0044s | 100% | [#19](../../issues/19) |
| 2 | GF(2) Minimal (2n samples) | [@SethTS](https://github.com/SethTS) | 601,157 | 0.0087s | 100% | [#17](../../issues/17) |
| 3 | GF(2) Gaussian Elimination | [@SethTS](https://github.com/SethTS) | 11,164,685 | 0.1011s | 100% | [#13](../../issues/13) |
| 4 | new gf2 proposed candidate | [@yaroslavvb](https://github.com/yaroslavvb) | 24,397,704 | 0.0019s | 100% | [#22](../../issues/22) |
<!-- LEADERBOARD_END -->
